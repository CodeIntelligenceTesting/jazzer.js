...
static_assert(sizeof(JazzerLibAflRuntimeOptions) == 80,
              "Unexpected JazzerLibAflRuntimeOptions layout");
static_assert(offsetof(JazzerLibAflRuntimeOptions, seed) == 16,
              "Unexpected seed offset");
static_assert(offsetof(JazzerLibAflRuntimeOptions, corpus_directories) == 48,
              "Unexpected corpus_directories offset");
static_assert(offsetof(JazzerLibAflRuntimeOptions, dictionary_files) == 64,
