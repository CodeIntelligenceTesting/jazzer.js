...
use crate::abi::{
    JazzerLibAflCompareLog, JazzerLibAflCompareLogEntry, COMPARE_KIND_INTEGER,
    COMPARE_KIND_STRING_CONTAINMENT, COMPARE_KIND_STRING_EQUALITY, COMPARE_LOG_ENTRY_BYTES,
    COMPARE_LOG_MAX_ENTRIES, COMPARE_LOG_SIGNED_FLAG,
};
